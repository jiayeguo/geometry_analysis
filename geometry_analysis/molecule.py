...
class Molecule:
    ...
    @property  # this is also called a getter (for users to retrieve data from private variables)
    def coordinates(self):
        return self._coordinates

    @coordinates.setter  # this is a setter for the users to make modifications to the coordinates (we run the build_bond function internally to make sure the bonds are not messed up from the change but the users don't have to know that)
